...
export default {
  ...
  methods: {
    ...
    paintChart(brushData) {
      ...
      selectionG.append('g').call(brush).call(brush.move, [50, 75])
      ...
      function switchBar(event, d) {
        ...
        // console.log(event)
        d3.select('.upperRiver').transition(t).attr('opacity', 0)
        d3.select('.AreaRiver').transition(t).attr('opacity', 0)
        d3.select('.barGroup').selectAll('g').transition(t).attr('opacity', 1)
        flag = 0
        d3.select('.areaChange').select('rect').attr('fill', 'white')
        d3.select('.areaChange').select('text').attr('fill', util.labelColor[1])
        d3.select('.barChange').select('rect').attr('fill', util.labelColor[1])
        d3.select('.barChange').select('text').attr('fill', 'white')
      }
      function switchArea() {
      ...
      /*   svg.select('.barChange')
        ...
        d3.select('.barChange').select('rect').attr('fill', 'white')
        d3.select('.barChange').select('text').attr('fill', util.labelColor[1])
        d3.select('.areaChange').select('rect').attr('fill', util.labelColor[1])
        d3.select('.areaChange').select('text').attr('fill', 'white')
      }
